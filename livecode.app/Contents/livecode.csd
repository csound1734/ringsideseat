<Cabbage>
	form caption("Untitled") bundle("reserveInstruments.txt", "drums2/drums.orc") size(1200, 200), colour(58, 110, 182), pluginId("def1") guiMode("queue")
